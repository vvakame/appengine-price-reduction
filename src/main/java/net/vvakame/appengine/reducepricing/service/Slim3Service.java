package net.vvakame.appengine.reducepricing.service;

import java.util.List;

import org.slim3.datastore.Datastore;
import net.vvakame.appengine.reducepricing.model.Slim3Model;
import net.vvakame.appengine.reducepricing.meta.Slim3ModelMeta;
